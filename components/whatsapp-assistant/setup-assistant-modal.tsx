...
export function SetupAssistantModal({ isOpen, onClose, onSuccess }: SetupAssistantModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[900px] max-h-[90vh] flex flex-col rounded-t-2xl rounded-b-2xl bg-white">
        {/* Header fisso con progress bar */}
        <div className="flex-none sticky top-0 z-10 bg-white pt-6 px-12 pb-4 shadow-sm rounded-t-2xl">
          <Progress 
