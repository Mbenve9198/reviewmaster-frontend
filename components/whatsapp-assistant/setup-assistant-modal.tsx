  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-screen h-screen max-w-none m-0 p-0 rounded-none bg-white">
        ...
        <div className="fixed top-0 left-0 right-0 z-10 bg-white pt-6 px-12 pb-4 shadow-sm">
          <Progress 
        ...
        <div className="flex h-full pt-20">
          ...
          <div className="w-1/2 overflow-y-auto px-12 py-8 border-r border-gray-200">
