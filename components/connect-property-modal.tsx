...
import { Hotel, BedDouble, Home, ArrowRight, Star } from 'lucide-react'
...
export function ConnectPropertyModal({ isOpen, onClose }: ConnectPropertyModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px] p-0 overflow-hidden rounded-3xl">
        <div className="bg-[#58CC02] p-4">
          <Progress value={progress} className="h-3 bg-[#4CAF00]" />
        </div>
        <div className="p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            {step === 1 ? (
              <>
                <div className="text-center mb-6">
                  <h2 className="text-2xl font-bold text-[#58CC02] mb-2">Property Details</h2>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      className="rounded-xl border-2 focus:border-[#58CC02] focus:ring-[#58CC02]"
                      required 
                    />
                  </div>
                  <div className="space-y-2">
              ...
              <>
                <div className="text-center mb-6">
                  <h2 className="text-2xl font-bold text-[#58CC02] mb-2">Connect Reviews</h2>
            ...
            <Button 
              ...
              className="w-full bg-[#58CC02] hover:bg-[#4CAF00] text-white rounded-xl py-6 text-lg font-bold"
            >
              {step === 1 ? (
