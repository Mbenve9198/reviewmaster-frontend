...
export function BillingAddressModal({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px] p-0 bg-white rounded-xl overflow-y-auto max-h-[85vh] border-0 shadow-xl">
            ...
            <div className="bg-white rounded-lg p-4 space-y-6">
              <div className="space-y-4">
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="text-xl font-semibold text-gray-800">{billingAddress.name}</h3>
